...
<div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto my-4 sm:my-10">
    ...
    <div class="sm:w-11/12 lg:w-3/4 mx-auto">
      ...
      <!-- End Card -->
        ...
        <div class="mt-6 flex justify-end gap-x-3">
            <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-50 dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="path/to/your/invoice.pdf" download="invoice.pdf">
            ...
            <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="#" onclick="window.print(); return false;">
  ...
  <!-- Ajoutez  agents de surveillance -->
  @foreach (json_decode($pv->agents) as agent )
  dd($agent) 
    <div class="grid grid-cols-3 sm:grid-cols-5 gap-2">
        <div class="col-span-full sm:col-span-2">
            <p class="font-medium text-gray-800 dark:text-neutral-200"> </p>
        </div>
        <div>
            <p class="text-gray-800 dark:text-neutral-200">123456</p>
        </div>
        <div>
            <p class="text-gray-800 dark:text-neutral-200">Présent</p>
        </div>
