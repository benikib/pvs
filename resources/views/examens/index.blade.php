              ...
              <table class="min-w-full">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                  ...
                  <tr>
                    ...
                    <td class="p-3 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200">{{ $examen->date }}</td>
                    <td class="p-3 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">{{ $examen->intitule }}</td>
                    <td class="p-3 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">{{ $examen->professeur }}</td>
                    ...
                    <td class="p-3 whitespace-nowrap text-end text-sm font-medium">
                        <div class="flex space-x-2">
                            <!-- Bouton Voir -->
                            <a href="{{ route("surveillants", [ 'id' => $examen->id]) }}" title="Voir"
